            ...
            <v-row>
                ...
                >
                    <v-card class="text-center pa-4" color="" >
                        ...
                        <div>
                            <v-btn color="primary" @click="$router.push({path: '/pages/page-form',query: {action: 'update',id: page.id}})" block>Manage</v-btn>
                        </div>
                    </v-card>
                </v-col>
                <v-col cols="3" col-md-3>
                    <v-card class="text-center pa-4 page-list-card-add" color="primary" dark @click="$router.push({path: '/pages/page-form',query: {action: 'publish'}})">
                        <div class="page-list-card">
